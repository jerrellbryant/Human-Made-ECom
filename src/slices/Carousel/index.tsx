...
const FLAVORS: {
  ...
  { flavor: "berryFineCherry", color: "#710523", name: "Berry Fine Cherry" },
  { flavor: "sourFaceGrape", color: "#572981", name: "Sour Face Grape" },
  { flavor: "lovelyLemonLime", color: "#164405", name: "Lovely Lemon Lime" },
  {flavor: "shadyStrawberry", color: "#690B3D", name: "Shady Strawberry"},
  { flavor: "heavenlyWatermelons", color: "#4B7002", name: "Heavenly Watermelons" },
];
...
function ArrowButton({direction ="right", label, onClick}:ArrowButtonProps) {
  return(
     <button onClick={onClick} className="size-12 rounded-full 
      border-2 border-white bg-white/10 p-3 opacity-85
      ring-white focus:outline-none focus-visible:opacity-100 
